...
//------------------------------------------------------------------------------";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var entryHubClass in receiver.EntryHubClasses)
            {
                ...
                foreach (var attribute in moduleHubAttributes)
                {
                    ...
                    {
                        var hubSource = ProcessHubClass(entryHubClass, moduleHubType);
        ...
        private string ProcessHubClass(INamedTypeSymbol entryHubTypeSymbol, INamedTypeSymbol moduleHubTypeSymbol)
        {
